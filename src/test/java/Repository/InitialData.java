...
public class InitialData {
    ...
    public void save() throws ParseException {
        ...
        event1.setTitle("PlayStation 4 VR");
        event1.setStartDate(format1.parse("2019-07-01"));
        event1.setDescription("Host an exciting, all-inclusive birthday video game party.Our video game parties are perfect for kids of all ages.Immerse yourself in extraordinary new worlds of virtual reality, put yourself at the center of an incredible gaming universe and experience a new way to play with PlayStation Virtual Reality.");
        event1.setMaxNumber("4");
        event1.setLocation("Shanghai");
        event1.setPhotoURL("event13.png");
